...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: nEy9BLWNBwZh/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: zU9gzLXu5GoG/icon
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___0GGzQ)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ne0AI)}
              role={"img"}
            />
          ),
