...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: C964vUW0Hr4I/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Y7ZmvQv6glP1/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___6LZc3)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__aadLi)}
              />
            </React.Fragment>
          ),
          value: args.children
