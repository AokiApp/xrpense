...
export type Error16SvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Error16SvgrepoComsvgIcon(props: Error16SvgrepoComsvgIconProps) {
...
export default Error16SvgrepoComsvgIcon;
/* prettier-ignore-end */
