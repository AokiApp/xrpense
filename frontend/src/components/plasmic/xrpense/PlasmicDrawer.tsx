...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: us1o9GMarTi_/css
...
function PlasmicDrawer__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_liuSVvHgAosf"]]: true })}
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__e1N1D)}
              >
                <div
                  className={classNames(
                    projectcss.all,
