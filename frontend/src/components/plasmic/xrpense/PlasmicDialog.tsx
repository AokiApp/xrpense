...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: DuaGFlJLalJe/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_SQuQClxxmCXq"]]: true })}
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__wmc5Q)}
              >
                <div
                  className={classNames(
                    projectcss.all,
